      ...
      {open ? (
        <div className="card-body stack">
          ...
          <ol className="steps-list">
            <li>
              <strong>Put the client in the game.</strong> Copy <span className="mono">GameApiClient.lua</span> from
              the repo into <span className="mono">ServerScriptService</span> as a ModuleScript. It is server-side
              only — a LocalScript would expose your API key to every player.
            </li>
            <li>
